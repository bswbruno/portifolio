...
const T = {
  pt:{
    ...
    about_p1:"Sou formado em Análise e Desenvolvimento de Sistemas e desenvolvedor Full Stack, com foco em Back-End e construção de aplicações escaláveis. Trabalho com desenvolvimento de APIs, integrações e regras de negócio, sem abrir mão da criação de interfaces modernas, acessíveis e bem estruturadas.",
    about_p2:"Busco desenvolver soluções completas que unam desempenho, qualidade e boa experiência para o usuário. Estou sempre aprimorando minhas habilidades e explorando novas tecnologias para criar produtos cada vez mais eficientes.",
    ...
    typing: ["Front-end", "Back-end", "Full-stack"]
  },
  en:{
